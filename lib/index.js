...
const schedule = {
  title: 'Longer life cycle',
  currentDuration: [{ months: 6 }, { months: 12 }],
  activeDuration: [{ months: 18 }, false],
};
schedule.maintenanceDuration = [
  { months: schedule.currentDuration[0].months + schedule.currentDuration[0].active },
  { months: 2 },
];
