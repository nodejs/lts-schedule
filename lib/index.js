...
const schedule = {
  title: 'LTS every year',
  alphaDuration: { months: 5 },
  betaDuration: { months: 1 },
  currentDuration: { months: 6 },
  activeDuration: { months: 12 },
};
schedule.maintenanceDuration = { months: schedule.currentDuration.months + schedule.activeDuration.months };
